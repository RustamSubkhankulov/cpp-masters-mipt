...
public:
    ...
    static void operator delete(void* pointer, const std::nothrow_t& tag) noexcept
    {
...
public:
    ...
    static auto GetMemoryStatistics() noexcept -> const Entity<Client>::MemoryStatistics&
    {

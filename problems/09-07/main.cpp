...
TEST(EntityTest, ConstructsImplementationInsideReservedStorage) {
  ...
  EXPECT_EQ(EntityInspector::implementation_address(entity),
            EntityInspector::storage_address(entity));
...
TEST(EntityTest, MoveConstructorTransfersState) {
  ...
  EXPECT_EQ(EntityInspector::implementation_address(target),
            EntityInspector::storage_address(target));
...
TEST(EntityTest, MoveAssignmentReusesExistingStorage) {
  ...
  void const* const target_address_before =
    EntityInspector::implementation_address(target);
...
TEST(EntityTest, MoveAssignmentFromSelfReferenceKeepsObjectValid) {
  ...
  void const* const address_before =
    EntityInspector::implementation_address(entity);

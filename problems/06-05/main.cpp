...
library_path ResolveLibraryPath(
...
std::string LoadMessageFromLibrary(
    std::string_view library_name,
    const library_path& library_directory)
{
...
[[maybe_unused]] int RunSelectedLibraryFromConsole()
{
    return static_cast<int>(
        RunSelectedLibrary(std::cin, std::cout, GetExecutableDirectory()));
}
